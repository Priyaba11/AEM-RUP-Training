...
@SlingServletPaths(
        value = {"/bin/executeworkflow","/ruptraining/executeworkflow"}
)
    ...
    protected void doGet(final SlingHttpServletRequest req, final SlingHttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            if(StringUtils.isNotBlank(payload)) {
                ...
                WorkflowModel workflowModel = workflowSession.getModel("/var/workflow/models/ruptraining-workflow-model");
