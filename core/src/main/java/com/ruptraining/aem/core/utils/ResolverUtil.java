package com.ruptraining.aem.core.utils;
...
public final class ResolverUtil {
    ...
    public static final String RUPTRAINING_SERVICE_USER = "ruptrainingserviceuser";
    /**
    ...
    public static ResourceResolver newResolver( ResourceResolverFactory resourceResolverFactory ) throws LoginException {
        ...
        paramMap.put( ResourceResolverFactory.SUBSERVICE, RUPTRAINING_SERVICE_USER );
