...
import com.ruptraining.aem.core.services.OSGiConfig;
...
public class OSGiConfigImpl implements OSGiConfig{
    ...
    @ObjectClassDefinition(name="RUP Training - OSGi Configuration",
    ...
    public @interface ServiceConfig {
        ...
        public String serviceName() default "RUP Training Service";
        ...
        String[] getCountries() default {"UK","India"};
